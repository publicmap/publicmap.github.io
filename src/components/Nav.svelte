...
<div id="offcanvas-nav-primary" uk-offcanvas="overlay: true">
  <div
    ...
    style="background:#222222d9">
    <ul class="uk-nav uk-nav-primary uk-nav-center uk-margin-auto-vertical">
      <li class={segment === undefined ? 'uk-active' : ''}>
        <a
          aria-current={segment === undefined ? 'page' : undefined}
          href={segment === undefined ? undefined : queryString ? '.?' + queryString : '.'}>
      ...
      <li class={segment === 'place' ? 'uk-active' : ''}>
        <a
          ...
          href="place"><span uk-icon="icon: list" />
          places
        </a>
      </li>
      <li class={segment === 'info' ? 'uk-active' : ''}>
        <a aria-current={segment === 'info' ? 'page' : undefined} href="info">
